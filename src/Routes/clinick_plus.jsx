...
function Clinick_plus() {
    return (
      <div>
        <div id="container">
        <div id="image">
           <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/9afc37bdf46fae888adf23d57cf627ad/u/n/untitled-202.jpg" alt="" />
        </div>
        <div id="info">
            <div>
                <h3 id="title_box">
                    <span id="title">Clinic Plus Strong & Long Health Shampoo - 650ml Each (Pack Of 2)
(650ml Each)</span>
                </h3>
                <span id="weight"></span>
                ...
                <div class="price-box price-final_price">
                    ...
                    <strike id="old_price">₹890.00</strike>
                    <span id="new_price">50% off</span>
                    <span>
                        <b id="discount">₹445.00 </b>
                    </span>
                </div>
