...
function About() {
    return (
      <div>
        <div id="container">
        <div id="image">
           <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/37253e89591b79b38c00254331932999/1/_/1_210_4.jpg" alt="" />
        </div>
        <div id="info">
            <div>
                <h3 id="title_box">
                    <span id="title">Clinic Plus Strong & Long Health Shampoo (650ml)
(650ml)
(650ml Each)</span>
                </h3>
                <span id="weight"></span>
                ...
                <div class="price-box price-final_price">
                    ...
                    <strike id="old_price">₹445.00</strike>
                    <span id="new_price">50% off</span>
                    <span>
                        <b id="discount">₹223.00 </b>
                    </span>
                </div>
