...
function Clinick_plus1() {
    return (
      <div>
        <div id="container">
        <div id="image">
           <img src="https://www.beautybebo.com/pub/media/catalog/product/cache/9afc37bdf46fae888adf23d57cf627ad/u/n/untitled-1_5_2.jpg" alt="" />
        </div>
        <div id="info">
            <div>
                <h3 id="title_box">
                    <span id="title">Clinic Plus Strong & Long Health Shampoo 340ml Each - Pack Of 2
(340ml Each)</span>
                </h3>
                <span id="weight"></span>
                ...
                <div class="price-box price-final_price">
                    ...
                    <strike id="old_price">₹318.00</strike>
                    <span id="new_price">40% off</span>
                    <span>
                        <b id="discount">₹191.00 </b>
                    </span>
                </div>
